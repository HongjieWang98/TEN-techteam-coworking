      ...
      <div className="privacycontent">
        ...
        <ol className="decimal">
          <div className="text">
            ...
            <ul>
              {' '}
              Thank you for choosing to be part of our community at Textbook Exchange Network. We are committed to
            ...
            <ul>
              {' '}
              When you visit our website https://textbookexchangenetwork.com/, and use our services, you trust us with
            ...
            <ul>
              ...
              https://textbookexchangenetwork.com/), and/or any related services, sales, marketing or events (we refer
          ...
          <li className="subtitle">
            ...
            <div className="short">
              <br />
              In Short: We collect personal information that you provide to us such as name, contact information, and
              payment information.
            </div>
            <div className="text2">
              <br />
              ...
              <br />
              <ul>
                Publicly Available Personal Information. We collect first name, last name, phone numbers, email
                addresses, and other similar data.
              </ul>
              <br />
              <ul>
                Personal Information Provided by You. We collect purchase history, financial information, app usage, and
                other similar data.
              </ul>
              <br />
              <ul>
          ...
          <li className="subtitle">
            ...
            <div className="text2">
              <br />
              <ul>We may process or share data based on the following legal basis: </ul>
              ...
              <div className="lower-latin">
                ...
                <li>
                  ...
                  require access to such information to do that work. Examples include: payment processing, data
                  analysis, email delivery, hosting services, customer service and marketing efforts. We may allow
                  selected third parties to use tracking technology on the Services, which will enable them to collect
                  data about how you interact with the Services over time. This information may be used to, among other
                  things, analyze and track data, determine the popularity of certain content and better understand
          ...
          <li className="subtitle">
            ...
            <div className="text2">
              ...
              <ul>
                ...
                collected from children under age 18, please contact us at textbookexchangenetwork@gmail.com.
              </ul>
              <br />
            </div>
          </li>
          ...
          <li className="subtitle">
            ...
            <div className="text2">
              ...
              <ul>
                ...
                information, or delete it in some circumstances. To request to review, update, or delete your personal
                information, please submit a request form by emailing us at textbookexchangenetwork@gmail.com
              </ul>
            </div>
          </li>
        </ol>
