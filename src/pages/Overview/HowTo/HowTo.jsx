  ...
  return(
    <div>
      ...
      <div className="SectionContent"> 
        The Textbook Exchange Network offers two products to universities, an in-person 
        exchange and a virtual exchange. Each university may only use one and each 
        exchange has different proccesses and rules. Please select your university 
        to see what kind of textbook exchange your school is using!
      </div>
    </div>
  );
}
            ...
            <Tab eventKey="sell" title="Selling">
              <Row>
                ...
                <Col md={4}>
                  ...
                  <div className='HowToText'>
                    If someone buys your book, you will receive an email and a
            ...
            <Tab eventKey="buy" title="Buying">
              <Row>
                <Col md={4}>
                  ...
                  <div className='HowToText'>
                    Check the current book inventory on the 'Browse' tab to ensure the Exchange
                    has the textbooks you need.
                  </div>
                </Col>
                <Col md={4}>
                  <div className='BigNumberYellow'>2</div>
                  <div className='HowToText'>
                    Go to the Textbook Exchange at the posted time, date, and
                    location. (Your student government will advertise this info!)
                  </div>
                </Col>
                <Col md={4}>
                  <div className='BigNumberYellow'>3</div>
                  <div className='HowToText'>
                    Find the textbook at the Exchange, checkout at a TEN Kiosk, 
                    and pay the seller. The book is now yours!
                  </div>
                </Col>
              </Row>
            </Tab>
            ...
            <Tab eventKey="sell" title="Selling">
              <Row>
                <Col md={4}>
                  <div className='BigNumberGreen'>1</div>
                  <div className='HowToText'>
                    Go to the 'Get started' tab and create an account with your school email. You can then
                    list as many textbooks as you would like from your home
                  </div>
                </Col>
                <Col md={4}>
                  <div className='BigNumberGreen'>2</div>
                  <div className='HowToText'>
                    'Accept' or 'Deny' a buyer via email when someone is interested in your book. If accepted, 
                    reach out to the buyer to coordinate an exchange. If denied, your book will be re-listed. 
                  </div>
                </Col>
                <Col md={4}>
                  <div className='BigNumberGreen'>3</div>
                  <div className='HowToText'>
                    Exchanges occur during a school specified time window and location. Payments should be made in person, 
                    and transactions should be confirmed online after they are completed.
                  </div>
                </Col>
              </Row>
            </Tab>
            <Tab eventKey="buy" title="Buying">
              <Row>
                <Col md={4}>
                  ...
                  <div className='HowToText'>
                    Go to the 'Get started' tab and create an account with your school email. You can then 
                    add any textbooks you're interested in to your card and checkout.
                  </div>
                </Col>
                <Col md={4}>
                  <div className='BigNumberYellow'>2</div>
                  <div className='HowToText'>
                    Sellers will be notified of your interest in the books. If the seller accepts you, they will 
                    reach out to coordinate a transaction. If denied, the exchange will be canceled
                  </div>
                </Col>
                <Col md={4}>
                  <div className='BigNumberYellow'>3</div>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingTwo">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
              What happens if the seller does not accept or reject me? What if they do but never reach out?
            </button>
          </h2>
