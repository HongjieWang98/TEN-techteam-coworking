  ...
  return(
    <div className='SectionWrapper'>
      <div className='SectionContent'>
        The Textbook Exchange Network is a 501(c)(3) nonprofit that was founded 
        at Tufts University in 2017. The mission of the Textbook Exchange Network (TEN) 
        is to increase access to affordable learning materials. To achieve this, TEN 
        provides software to run student-to-student exchanges that facilitates the 
        communication between buyers and sellers. TEN now saves students across the 
        United States $100,000+ annually.
      </div>
    </div>
  );
}
...
function StatisticCanvas(props) {
  ...
  useEffect(() => {
    ...
    ctx.arc(
      ...
      rad,
      -Math.PI / 2,
      2 * Math.PI * props.completion - Math.PI / 2
    );
    ctx.stroke();
...
function ProblemStatement() {
  return(
    <div className='SectionWrapper'>
      ...
      <div className='SectionContent'>
        Rising textbook prices undermine a university’s ability to educate its
        students. In the US, textbooks have assumed a new role. Rather than
        acting as key learning tools, textbooks have become prohibitive
        barriers for students’ academic careers. A market imbalance exists
        wherein there is no consumer control. Professors choose expensive,
        well-renowned textbooks and students are left scrambling to find an
  ...
  return (
    <div className='SectionWrapper'>
      ...
      <div className='SectionSubtitle'>
        We&#8217;re making textbooks more affordable.
      </div>
      <div className='SectionContent'>
        Expensive textbooks are daunting, but we have a solution. We help
        students to buy and sell their textbooks, in an effort to offset the
        high costs of college. We were founded in 2017 at Tufts University,
        but have since spread to a number of new campuses. We offer a
        student-run alternative that brings classmates together to make
      ...
      <div className='row DescriptionRow'>
        <div className='col-md-6 DescriptionTextWrap align-self-center'>
          ...
          <div className='SideDescription'>
            Our business model reduces inefficiencies in on-campus textbook
            exchange markets. Better yet: we do not charge students for transactions.
          </div>
        </div>
        <div className='col-md-2'></div>
        <div className='col-md-4 ImageWrap'>
          <img
            className='DescriptionImages img-responsive fit-image'
            src={booksdisplayimage}
          />
        </div>
      </div>
      <div className='row DescriptionRow'>
        ...
        <div className='col-md-6 DescriptionTextWrap align-self-center order-sm-first order-first order-md-last'>
          ...
          <div className='SideDescription'>
            Our software and process facilitates the exchange of over $100,000 worth of
            textbooks each year, and has spread to a number of universities
            since opening at Tufts. 
          </div>
        </div>
      </div>
      <div className='row DescriptionRow'>
        <div className='col-md-6 DescriptionTextWrap align-self-center'>
          ...
          <div className='SideDescription'>
            TEN is entirely volunteer run. Many of our volunteers are also students, 
            who have the opportunity to gain real world experience developing commercial
            software.
          </div>
        </div>
        <div className='col-md-2'></div>
